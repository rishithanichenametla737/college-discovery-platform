...
export default function ManageCollegesPage() {
  ...
  const inputClass =
    "w-full rounded-lg border border-gray-300 bg-white p-3 text-gray-900 placeholder:text-gray-500 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200";

  const selectClass =
    "w-full rounded-lg border border-gray-300 bg-white p-3 text-gray-900 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200";
        ...
        <section className="rounded-2xl bg-white p-6 shadow">
          ...
          >
            ...
            <div className="flex gap-4 md:col-span-2">
              <button
                type="submit"
                className="flex-1 rounded-lg bg-blue-600 p-3 font-bold text-white transition hover:bg-blue-700"
              >
                {editingId !== null
                  ? "✏️ Update College"
                  : "➕ Add College"}
              ...
              {editingId !== null && (
                <button
                  type="button"
                  onClick={cancelEdit}
                  className="rounded-lg bg-gray-500 px-6 py-3 font-bold text-white transition hover:bg-gray-600"
                >
                  Cancel
                </button>
              )}
        ...
        <section className="mt-8 rounded-2xl bg-white p-6 shadow">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 bg-white p-3 text-gray-900 placeholder:text-gray-500 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 md:w-96"
            />
          </div>
          ...
          {loading ? (
            ...
            <div className="mt-6 grid gap-5 md:grid-cols-2">
              {filteredColleges.map((college) => (
                <div
                  key={college.id}
                  className="rounded-xl border border-gray-200 bg-white p-5 text-gray-800 shadow-sm"
                >
